...
void SysCfb_Init(s32 n64dd) {
    ...
    // sSysCfbEnd &= ~0x3F;
    sSysCfbEnd = 0x80700000 + screenSize * 2;
    ...
    sSysCfbFbPtr[0] = 0x80600000;
    sSysCfbFbPtr[1] = 0x80700000;
    PRINTF(T("フレームバッファのアドレスは %08x と %08x です\n", "Frame buffer addresses are %08x (%08x) and %08x (%08x)\n"),
           sSysCfbFbPtr[0], sSysCfbEnd - (screenSize * 4), sSysCfbFbPtr[1], sSysCfbEnd - (screenSize * 2));
}
