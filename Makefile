...
$(LDSCRIPT): $(BUILD_DIR)/spec
	...
	$(V)$(MKLDSCRIPT) $< $@ $(BUILD_DIR)/src/makerom $(SEGMENTS_DIR)
...
$(BUILD_DIR)/baserom/%.o: $(EXTRACTED_DIR)/baserom/%
	$(call print_two_args,Wrapping binary to ELF:,$<,$@)
	$(V)$(OBJCOPY) -I binary -O $(LD_OFORMAT) $< $@
...
$(BUILD_DIR)/src/makerom/ipl3.o: $(EXTRACTED_DIR)/incbin/ipl3
	$(call print,Compiling:,$<,$@)
	$(V)$(OBJCOPY) -I binary -O $(LD_OFORMAT) --rename-section .data=.text $< $@
...
$(BUILD_DIR)/assets/%.inc.c: assets/%.png
	$(V)$(BUILD_FROM_PNG) $< $(dir $@) assets/$(dir $*) $(wildcard $(EXTRACTED_DIR)/assets/$(dir $*))
...
$(BUILD_DIR)/assets/%.inc.c: $(EXTRACTED_DIR)/assets/%.png
	$(V)$(BUILD_FROM_PNG) $< $(dir $@) $(wildcard assets/$(dir $*)) $(EXTRACTED_DIR)/assets/$(dir $*)
